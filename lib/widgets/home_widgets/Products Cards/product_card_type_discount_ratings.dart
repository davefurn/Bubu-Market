                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        Row(
                         ...
                         const  Padding(
                            ...
                            RatingBar.builder(
                              unratedColor: const Color.fromARGB(135, 205, 201, 201),
                              itemSize: 19,
                              initialRating: 3,
                              minRating: 1,
                   ...
                   counter == 0
                        ? CustomButton(
                            text: 'Add To Cart',
                            onpressed: () => ref.read(stateProviderInteger1.notifier).state++,
                            thickLine: 1,
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        borderRadius: BorderRadius.circular(30),
                                         onTap: () => ref.read(stateProviderInteger1.notifier).state--,
                                        child: Container(
                                          height: 32,
                                          width: 32,
                                          decoration: BoxDecoration(
