...
class EmailMe extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: 42,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), color: const Color(0xffeeeeee),),
      ...
      child:  TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Icon(Icons.email_outlined, color: Color.fromARGB(255, 232, 235, 240), size: 24,),
              suffixIcon: null,
