...
class _MainViewState extends ConsumerState<MainView> {
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
              icon: Icon(
                bottomSelectedItem == 2 ? Icons.person : Icons.person_outline,
                color: Colors.black,
              ),
              label: 'Contact',
            ),
            ...
            //     icon: Icon(
            //       _currentIndex == 3 ? Icons.notifications
  ...
  Widget _buildDrawer() => ListView.separated(
  ...
  Widget _buildDrawerHeader(Menu headItem) => SizedBox(
        height: 45,
        child: DrawerHeader(
